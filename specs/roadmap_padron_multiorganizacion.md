...
- Pendiente: la migración real de PK — empaqueta id UUID nuevo + UNIQUE(ID_Organizacion, ID_Socio/ID_Parcela_Fija) + fix de las 2 vistas del Dashboard + fix de la cascada deactivateSocio. Certificaciones normalizadas y multi-producto: no iniciados.
