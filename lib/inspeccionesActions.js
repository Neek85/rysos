 ...
 * 20260818_inspecciones_atomic_save.sql). Antes esto eran 7 llamadas REST
 * independientes (Promise.all) sin transacción de base de datos — una
 * falla a mitad de camino dejaba registros huérfanos/parciales. La
 * verificación multi-tenant client-side se mantiene como fail-fast antes
 * del round-trip de red; la función RPC repite la misma verificación del
 * lado del servidor como autoridad real (nunca confiar solo en el chequeo
 * del cliente).
 *
