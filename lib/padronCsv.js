...
// Mejoras importador padrón masivo (spec sección 9.3, ronda 6): alias
// defensivo de los labels VIEJOS de hip/hrp (antes de la corrección
// semántica de la ronda 3, "Ha. Infraestructura Productiva"/"Ha.
// Reserva/Protección") -- por si queda algún archivo exportado ANTES del
// cambio de label. Se agregan DESPUÉS de construir el mapa desde
// PARCELA_FIELD_LABELS (que ya solo tiene el label nuevo) para no romper
// esa única fuente de verdad -- este archivo es el único lugar que
// necesita reconocer ambos, ParcelaFormModal.jsx no lee CSVs.
...
// departamento/provincia (ver docs/schema_live.md:234-238 y el propio
