...
const PARCELA_TEMPLATE_EXAMPLE = {
...
export function buildParcelaTemplateCsv() {
  return arrayToCsv([PARCELA_TEMPLATE_EXAMPLE], PARCELA_TEMPLATE_COLUMNS, PARCELA_FIELD_LABELS)
}
...
export function downloadParcelaTemplate() {
  triggerCsvDownload('Plantilla_Parcelas.csv', buildParcelaTemplateCsv())
}
