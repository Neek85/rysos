...
// es la autoridad, no un bypass. `approveQcRecord`/`rejectQcRecord`
// siguen con Service Role Key, sin tocar — motivo en el ADR (falta
// diferenciar por rol, no solo por organización).
