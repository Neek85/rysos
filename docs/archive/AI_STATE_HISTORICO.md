# AI_STATE_HISTORICO.md

> Archivo histórico de `AI_STATE.md` — bloqueos y diagnósticos ya
> resueltos o cerrados, movidos acá en la rotación de 2026-09-04
> (ver `CLAUDE.md`, sección de economía de tokens). No se lee por
> defecto — consultar solo si hace falta el detalle histórico
> completo de una entrada específica ya cerrada.
